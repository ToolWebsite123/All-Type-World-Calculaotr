    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Trapezoid Calculator", description: "Full trapezoid solver for scalene, isosceles and right trapezoids: find area, missing base, or height; full solve from (a, b, c, ∠A) or (a, b, ∠A, ∠D) or all 4 sides; area from diagonals and their angle; or from 4 vertex coordinates via the shoelace formula. Reports area, perimeter, height, midsegment, all four interior angles and both diagonals with a live labeled SVG diagram, unit selector and material/cost estimator.", icon: Shapes, slug: "trapezoid", href: "/calculators/math/trapezoid-calculator" },
